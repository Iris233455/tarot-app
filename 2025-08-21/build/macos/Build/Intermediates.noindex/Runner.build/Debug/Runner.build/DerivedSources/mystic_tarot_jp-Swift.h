...
#ifndef MYSTIC_TAROT_JP_SWIFT_H
#define MYSTIC_TAROT_JP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="mystic_tarot_jp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC15mystic_tarot_jp11AppDelegate")
...
SWIFT_CLASS("_TtC15mystic_tarot_jp17MainFlutterWindow")
