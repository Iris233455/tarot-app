...
class _DrawCardsScreenState extends ConsumerState<DrawCardsScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(ref.watch(appStringsProvider).readingTitle),
  ...
  Widget _buildCardCountSelector() {
    return Container(
      ...
      child: Column(
        children: [
          Text(
            ref.watch(appStringsProvider).labelSelectCardCount,
            ...
            if (_currentState == CardDrawState.initial)
              Expanded(
                child: ElevatedButton(
                  ...
                  child: Text(ref.watch(appStringsProvider).buttonShuffle),
                ),
              ),
            ...
            if (_currentState == CardDrawState.cutting)
              Expanded(
                child: ElevatedButton(
                  ...
                  child: Text(ref.watch(appStringsProvider).buttonCut),
                ),
              ),
            ...
            if (_currentState == CardDrawState.drawing)
              Expanded(
                child: ElevatedButton(
                  ...
                  child: Text(ref.watch(appStringsProvider).buttonDrawCards),
                ),
              ),
            ...
            if (_currentState == CardDrawState.revealed) ...[
              Expanded(
                child: ElevatedButton(
                  ...
                  child: Text(ref.watch(appStringsProvider).buttonAgain),
                ),
              ),
            ],
          ],
