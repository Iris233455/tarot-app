  ...
  static Future<String> getTarotReading({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return data['result'] ?? ref.watch(appStringsProvider).messageAIResultNotAvailable;
      } else {
      ...
      throw AIServiceException(
        ref.watch(appStringsProvider).messageNetworkConnectionError,
      );
    } on FormatException {
      throw AIServiceException(
        ref.watch(appStringsProvider).messageResponseParseFailed,
      );
    } catch (e) {
      throw AIServiceException(
        '${ref.watch(appStringsProvider).messageUnexpectedError}: $e',
      );
    }
  }
