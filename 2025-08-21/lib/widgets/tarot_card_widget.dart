...
class _TarotCardWidgetState extends State<TarotCardWidget>
  ...
  String _getSuitName() {
    ...
    if (filename.startsWith('major_')) {
      return ref.watch(appStringsProvider).labelMajorArcana;
          } else if (filename.contains('wands')) {
        return ref.watch(appStringsProvider).labelWands;
      } else if (filename.contains('cups')) {
        return ref.watch(appStringsProvider).labelCups;
      } else if (filename.contains('swords')) {
        return ref.watch(appStringsProvider).labelSwords;
      } else if (filename.contains('pentacles')) {
        return ref.watch(appStringsProvider).labelPentacles;
      } else {
        return ref.watch(appStringsProvider).labelUnknown;
    }
  }
} 